...
- **Swiss Watch Expo (Shop pre-owned luxury watches)** → Built front-end using HTML5, CSS3, JS, JS libraries. [Live Website](https://www.swisswatchexpo.com/)
- **Mr. Bracelet (Shop pre-owned luxury watches)** → Built front-end using HTML5, CSS3, Shopify. [Live Website](https://www.mrbracelet.com/)
